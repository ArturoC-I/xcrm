    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('YouTube', 'YouTube'), ('Yandex', 'Yandex'), ('Новостная_рассылка', 'Новостная_рассылка')], max_length=100)),
                ('company', models.CharField(max_length=40)),
                ('phone_company', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None)),
                ('email_company', models.EmailField(max_length=254, unique=True)),
